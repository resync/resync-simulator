...
class TestSitemap(unittest.TestCase):
    ...
    def test_01_print(self):
        ...
        self.assertEqual( Sitemap().inventory_as_xml(i), '<?xml version=\'1.0\' encoding=\'UTF-8\'?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:rs="http://resourcesync.org/change/0.1"><atom:link attributes="self next" href="http://example.org/changeset1" type="changeset" /><url><loc>a</loc><lastmod>2001-01-01T00:00:00</lastmod><rs:size>1234</rs:size></url></urlset>' )
