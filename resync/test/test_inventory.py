...
class TestInventory(unittest.TestCase):
    ...
    def test2_changed(self):
        ...
        self.assertEqual( changed[0].uri, 'a', "first was a" )
        self.assertEqual( changed[1].uri, 'b', "second was b" )
        self.assertEqual( len(deleted), 0, "nothing deleted" )
        self.assertEqual( len(added), 0, "nothing added" )
    ...
    def test3_deleted(self):
        ...
        self.assertEqual( deleted[0].uri, 'c', "first was c" )
        self.assertEqual( deleted[1].uri, 'd', "second was d" )
        self.assertEqual( len(added), 0, "nothing added" )
    ...
    def test4_added(self):
        ...
        self.assertEqual( added[0].uri, 'b', "first was b" )
        self.assertEqual( added[1].uri, 'd', "second was d" )
    ...
    def test7_changeset(self):
        ...
        self.assertEqual(first.changetype, 'X', "changes[0].changetype=X")
        second = i.next()
        self.assertEqual(second.timestamp, 4, "changes[1].timestamp=4")
        self.assertEqual(second.changetype, 'X', "changes[1].changetype=X")
